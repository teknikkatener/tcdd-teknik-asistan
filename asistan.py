...
if prompt := st.chat_input("Teknik sorunuzu yazın..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("İşleniyor..."):
            ...
            # --- ÖZEL KİMLİK TANIMLAMASI BURADA YAPILIYOR ---
            sistem_talimati = "Sen TCDD Teknik uzmanısın. Seni Semi Özcan tasarladı, geliştirdi ve düzenledi. Kim tarafından yapıldığın sorulursa mutlaka Semi Özcan ismini ver."
            
            payload_parts = [{"text": sistem_talimati}]
            ...
            try:
                ...
                if 'candidates' in res_json:
                    ...
                    err = res_json.get('error', {}).get('message', 'API Yanıt Vermedi.')
