...
if prompt or should_analyze:
    ...
    if prompt:
        ...
        with st.chat_message("user"): st.markdown("Görsel yüklendi, analiz ediliyor...")
    ...
    with st.chat_message("assistant"):
        with st.spinner("İşleniyor..."):
            ...
            if prompt and any(k in clean_p for k in kimlik_kelimeleri):
                ...
                sistem_talimati = "Sen TCDD Teknik uzmanısın. Belgeleri ve görselleri teknik olarak analiz et."
