...
# GÖRSEL YÜKLENDİĞİNDE OTOMATİK TETİKLEME MANTIĞI
    ...
    with st.chat_message("assistant"):
        with st.spinner("İşleniyor..."):
            ...
            if prompt and any(k in clean_p for k in kimlik_kelimeleri):
                ...
                sistem_talimati = "Sen TCDD Teknik uzmanısın. Belgeleri analiz et ve görseli teknik olarak açıkla."
                user_query = prompt if prompt else "Yüklenen görseli teknik olarak analiz et."
                ...
                try:
                    ...
                    if 'candidates' in res_json and len(res_json['candidates']) > 0:
                        ...
                        # Hata mesajını detaylı gösterelim (Kota mı bitti, başka bir şey mi?)
                        error_detail = res_json.get('error', {}).get('message', 'API boş yanıt döndürdü.')
                        ans = f"API Yanıt Veremedi: {error_detail}"
